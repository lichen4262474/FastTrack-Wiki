...
//	  // After saving companies
//	  companyRepository.saveAllAndFlush(Arrays.asList(company1, company2));
//	  System.out.println("Company IDs:");
//	  companyRepository.findAll().forEach(c -> System.out.println("Company ID: " + c.getId()));
//
//// After saving teams
//	  teamRepository.saveAllAndFlush(Arrays.asList(team1, team2, team3, team4, team5, team6, team7));
//	  System.out.println("Team IDs:");
//	  teamRepository.findAll().forEach(t -> System.out.println("Team ID: " + t.getId() + ", Company ID: " + t.getCompany().getId()));
//
//// After saving projects
//	  projectRepository.saveAllAndFlush(Arrays.asList(project1, project2, project3));
//	  System.out.println("Project IDs:");
//	  projectRepository.findAll().forEach(p -> System.out.println("Project ID: " + p.getId() + ", Team ID: " + p.getTeam().getId()));
  }
